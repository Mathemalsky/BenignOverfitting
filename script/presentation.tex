...
\vspace{0.1cm}
\pause
\includegraphics[width=\textwidth]{BenignOverfittingModel.png}
\end{frame}
...
\begin{center}
\includegraphics[width=\textwidth]{theta_plot_1.png}
\end{center}
\end{frame}

\begin{frame}{Polynomial fitting examples}
\begin{center}
\includegraphics[width=\textwidth]{theta_coefficients_1.png}
\end{center}
\end{frame}

\begin{frame}{Polynomial fitting examples}
\begin{center}
\includegraphics[width=\textwidth]{theta_plot_2.png}
\end{center}
\end{frame}
...
\end{itemize}
\begin{center}
	\includegraphics[scale=0.15]{mnist.png}
\end{center}
\end{frame}
...
\begin{center}
	\includegraphics[width=\textwidth]{density_unregularized.png}
\end{center}
\end{frame}
